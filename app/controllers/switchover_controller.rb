...
class SwitchoverController < ApplicationController
  def index
    Rails.logger.info("Events Production Logging Test Start")
    Rails.logger.info("SwitchoverController#index called")
    ...
    Sentry.capture_message("Switchover#index Sentry Test")
